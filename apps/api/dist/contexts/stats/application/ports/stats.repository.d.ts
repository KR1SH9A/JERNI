...
export interface StatsRepository {
     ...
     */
    upsertAllTimeStat(journeyId: string, userId: string, taskKind: 'MILESTONE' | 'RECURRING', forDate: string | null, delta: 1 | -1): Promise<void>;
    /**
...
export declare const STATS_REPOSITORY: unique symbol;
